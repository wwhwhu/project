...
public class changeType {
    ...
    private static final int HOP_LENGTH = 300; // 帧移大小
    private static final int N_MELS = 80; // Mel滤波器数量
    private static final int SR = 16000; // 采样率
    ...
    public static float[][] computeMelSpectrogram(float[] audioData) {
        ...
        // 初始化一个数组来保存STFT结果
        Log.d("model", "STFT shape: [" + Integer.toString(N_FFT / 2 + 1) + Integer.toString(nFrames) + "]");
